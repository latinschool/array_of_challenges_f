...
#But there's a problem. We don't know who the donuts belong to!


#Create a hash where donuts are assigned to specific classmates


#Puts the donut of a specific person

#Add another donut classmate pair into your hash

#Find a method that lets you see all the donuts of your hash
